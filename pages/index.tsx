...
const Index = () => {
  return (
    <main className="main__content_wrapper">
      <section className="hero__slider--section slider__section--bg3">
        <div className="container">
          <div className="row">
            <div className="col-lg-6 col-md-7">
              <div className="slider__content style3">
                <h2 className="slider__content--maintitle style3 h1">
                  Natural Materials Time Nekleg.{' '}
                </h2>
                <p className="slider__content--desc style3">
                  There are many variations of sum availabled in alley of type and scrambled it
                  some.
                </p>
                <div className="slider__content--footer style3 d-flex align-items-center">
                  <a className="slider__content--btn primary__btn" href="shop.html">
                    Shop Now
                  </a>
                  <div className="bideo__play slider__play--bideo">
                    <a
            ...
            <div className="col">
              <div className="image__with--text__thumbnail">
                <img
                  ...
                  src="assets/img/other/about-thumb3.webp"
                  alt="drone-image"
                />
              </div>
            </div>
            <div className="col">
              <div className="image__with--text__content">
                ...
                <p className="image__with--text__desc mb-25">
                  Beyond more stoic this along goodness this sed wow manatee mongos flusterd
                  impressive man farcrud opened inside owin punitively wasteful telling spransac
                  coldly spokeles.
                </p>
                ...
                <div className="image__with--text__content--footer d-flex">
                  <img
                    className="display-block"
                    src="assets/img/other/text-shape2.webp"
                    alt="text-shape"
                  />
      ...
      <section className="image__with--text__section--style2 image__with--text__section--bg section--padding">
        <div className="container">
          <div className="row  align-items-center">
            <div className="col-lg-7 col-md-7 col-sm-order">
              <div className="image__with--text__content--style2">
                <h2 className="image__with--text__title--style2 text-white mb-18">
                  We Have This 20% off <br />
                  Colored Jewelry.
                </h2>
                <p className="image__with--text__desc--style2 text-white mb-25">
                  There are many variations of passages of Lorem Ipsum available but the majority
                  have suffered alteration.Beyond more stoic this along goodness this sed wow
                  manatee mongos flusterd impressive man opened inside owin punitively{' '}
                </p>
                <div className="image__with--text__content--price mb-28">
                  <span className="old__price"> $30.00</span>
                  <span className="price__divided"></span>
                  <span className="current__price">$25.00</span>
                </div>
            ...
            <div className="col-lg-5 col-md-5">
              <div className="image__with--text__thumbnail--style2">
                <img
                  className="image__with--text__thumbnail--img__style2 display-block"
                  src="assets/img/other/ring-image.webp"
      ...
      <section className="display__banner--section">
        <div className="container-fluid">
          <div className="display__banner--bg">
            <div className="display__banner--content text-center">
              <h2 className="display__banner--content__title"> This Builders Best Jewelry</h2>
              <p className="display__banner--content__desc">
                Beyond more stoic this along goodness this sed wow manatee mongos flusterd
                impressive man opened in punitively{' '}
              </p>
              <a className="display__banner--content__btn primary__btn" href="shop.html">
                View Collection
              </a>
            </div>
          </div>
        ...
        <div className="container">
          <div className="section__heading text-center mb-50">
            ...
            <p className="section__heading--desc">
              Beyond more stoic this along goodness this sed wow manatee mongos flusterd impressive
              man farcrud opened.
            </p>
          </div>
                    ...
                    <div className="swiper-wrapper">
                      ...
                      <div className="swiper-slide">
                        <div className="product__media--nav__items">
                          <img
                            className="product__media--nav__items--img"
                            src="assets/img/product/small-product7.webp"
                            alt="product-nav-img"
                          />
                        </div>
                      </div>
                      <div className="swiper-slide">
                        <div className="product__media--nav__items">
                          <img
                            className="product__media--nav__items--img"
                            src="assets/img/product/small-product8.webp"
                            alt="product-nav-img"
                          />
                        </div>
                      </div>
                ...
                <div className="product__details--info">
                  <form action="#">
                    ...
                    <div className="guarantee__safe--checkout">
                      ...
                      <img
                        className="guarantee__safe--checkout__img display-block"
